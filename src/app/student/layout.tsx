    ...
    const fetchUser = async () => {
      try {
        ...
        if (userData.success && userData.user) {
          if (userData.user.role !== "STUDENT" && userData.user.role !== "ADMIN") {
            router.push("/login");
            return;
          }
        ...
        if (teachersRes.ok) {
          ...
          if (teachersData.success && Array.isArray(teachersData.teachers)) {
            setTeacherCount(teachersData.teachers.length);
          }
        }
      } catch (err) {
  ...
  return (
    <div className="portal-layout-root">
      ...
      <main className="portal-main-container">
        ...
        {user?.mustChangePassword && pathname !== "/student/security" && (
          <div style={{ 
