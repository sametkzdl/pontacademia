    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#F0F5FB", display: "flex", flexDirection: "column" }}>
      ...
      <main className="container" style={{ flexGrow: 1, padding: "32px 24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "24px" }}>
          ...
          {/* Sol Kolon: Öğrenci Profil Kartı */}
          <div style={{ backgroundColor: "#FFFFFF", borderRadius: "16px", padding: "28px", border: "1px solid #DDE6F0", boxShadow: "0 4px 16px rgba(15, 38, 69, 0.04)" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "14px", fontSize: "14px" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "10px", color: "#334155" }}>
                <BookOpen size={16} color="#C8952A" /> <span>Sınıf / Seviye: <strong>{profile?.grade || "Belirtilmedi"}</strong></span>
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: "10px", color: "#334155" }}>
                <Target size={16} color="#C8952A" /> <span>Hedef / Ders: <strong>{profile?.target || profile?.subject || "Belirtilmedi"}</strong></span>
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: "10px", color: "#334155" }}>
                <MapPin size={16} color="#C8952A" /> <span>Şehir: {profile?.city || "İstanbul"}</span>
              </div>
            </div>
          </div>
      ...
      {/* Öğrenci Profil Düzenleme Modalı */}
      {isEditModalOpen && (
        <div style={{ position: "fixed", inset: 0, backgroundColor: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000, padding: "20px" }}>
          <div style={{ backgroundColor: "#FFFFFF", borderRadius: "16px", padding: "28px", maxWidth: "520px", width: "100%", maxHeight: "90vh", overflowY: "auto", boxShadow: "0 20px 50px rgba(0,0,0,0.2)" }}>
      ...
      <footer style={{ padding: "20px 0", textAlign: "center", fontSize: "12px", color: "#94A3B8" }}>
        © 2026 Pont Academy. Öğrenci Portalı.
      </footer>
    </div>
  );
}
