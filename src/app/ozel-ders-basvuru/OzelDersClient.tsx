...
import { ALL_ISTANBUL_DISTRICTS as ALL_DISTRICTS } from "@/constants";
...
export default function OzelDersClient() {
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "20px" }}>
                    ...
                    <div className="form-group" style={{ marginBottom: 0 }}>
                      ...
                      >
                        ...
                        <option value="11. Sınıf (YKS Ön Hazırlık)">11. Sınıf (YKS Ön Hazırlık)</option>
